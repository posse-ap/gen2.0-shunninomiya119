...
<body>
    ...
    <header id="header" style="z-index: 999999999;">
        <div class="header_wrapper">
            ...
            <h4>
                <a href="/">
                    <svg width="100px" height="40px" viewBox="0 0 228 86" version="1.1" xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="header-right">
                ...
                <a class="subtint-button header-right-create" href="/prepare">
                    クイズ・診断を作る
                </a>
    
                <a href="/search" class="header-right-search">
                    <svg class="search_mark" xmlns="http://www.w3.org/2000/svg"  width="20" height="20" viewBox="0 0 20 20">
                        <path
    ...
    <?php 
            $sql = "SELECT * FROM questions WHERE big_questions_id =' ". $id ." ' ";
    ...
    <div class="content_wrapper">
        ...
        <img src="../images/<?= $row['image']; ?>" class="image">
